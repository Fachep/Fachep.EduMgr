...
public class EnrollmentQuery : QueryBase
{
    [QueryPath(nameof(Enrollment.OwnerId))]
    public long? StudentId
    {
        get;
        set
        {
            ((IQueryBase)this).MarkAsSet(nameof(StudentId));
            field = value;
        }
    }
    ...
    [QueryPath(nameof(Enrollment.Course), nameof(Course.SubjectId))]
    ...
    [QueryPath(nameof(Enrollment.Course), nameof(Course.OwnerId))]
    ...
    [QueryPath(nameof(Enrollment.Course), nameof(Course.Subject), nameof(Subject.OwnerId))]
    ...
    [QueryPath(nameof(Enrollment.Course), nameof(Course.Subject), nameof(Subject.Name))]
